...
ActiveRecord::Schema.define(version: 2019_09_24_042526) do
  ...
  create_table "corrects", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "question_id"
    t.integer "y_count", default: 0, null: false
    t.integer "n_count", default: 0, null: false
    t.integer "accuracy", default: 0, null: false
    t.integer "sum", default: 0, null: false
    t.integer "pick", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "last"
    t.index ["question_id"], name: "index_corrects_on_question_id"
